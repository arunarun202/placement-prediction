...
class Network_data_form(forms.ModelForm):

    class Meta:

        model=UserPredictModel1
        fields=['Age', 'Gender', 'Qualification', 'year', 'cgpa', 'Job_Role',
       'Post_Graduation', 'ten_Percentage', 'twelth_Percentage',
       'Salary', 'Soft_Skills', 'Internship', 'Experience', 'Round',
       'Company_Name']
...
class ResumeUploadForm(forms.ModelForm):
    class Meta:
        model = ResumeUpload
        fields = ['name', 'email', 'job_role', 'file']  

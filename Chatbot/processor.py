...
model = load_model('Chatbot/chatbot_modelJ.h5')
import json
import random
...
words = pickle.load(open('Chatbot/wordsJ.pkl','rb'))
classes = pickle.load(open('Chatbot/classesJ.pkl','rb'))
...
def getResponse(ints, intents_json, source_lang='en', target_lang='en', save_path="Responses/response.mp3"):
    tag = ints[0]['intent']
